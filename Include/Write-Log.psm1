...
.PARAMETER
    First is the message block
.PARAMETER
    Second is the 6 char "type"
.PARAMETER
    Third is a flag that if set to $false will not actually record anything (to make verbose logging easier in your script).

.OUTPUT
    Returns $true for lack of errors, $false for critical failure
